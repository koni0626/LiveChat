...
class Config:
    ...
    LIVE_CHAT_IMAGE_AI_PROVIDER = os.getenv("LIVE_CHAT_IMAGE_AI_PROVIDER", "").strip()
    LIVE_CHAT_IMAGE_AI_MODEL = os.getenv("LIVE_CHAT_IMAGE_AI_MODEL", "").strip()
    LIVE_CHAT_IMAGE_QUALITY = os.getenv("LIVE_CHAT_IMAGE_QUALITY", "").strip()
    ...
    TEXT_AI_TIMEOUT_SECONDS = int(os.getenv("TEXT_AI_TIMEOUT_SECONDS", "900"))
