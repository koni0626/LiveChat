...
def build_scene_choice_prompt(context: dict, speaker_name: str, message_text: str) -> str:
    ...
    lines = [
        ...
        "各 choice には label, intent, choice_type, scene_instruction, image_prompt_hint, reply_hint が必要です。",
        "choice_type は location_move, area_shift, look_at_info, action, emotion, topic, photo のいずれかにしてください。",
        "Feedを見る、ニュースを見る、噂を確認する、端末を見る、地図を見る、投稿を読む、掲示板を見る、放送を聞く、ログを見る、資料を見る、メニューを見る、写真を見る は look_at_info です。場所移動ではありません。",
        "質問する、相談する、からかう、手を取る、近づく、選ぶ、渡す、食べる、飲む、買う、試す、褒める、慰める、笑う、考える は location_move ではありません。",
        "別施設へ行く、別の場所へ向かう、移動する、出る、入る、奥へ進む、通路へ向かう、区画を変えるなど明確な移動だけ location_move または area_shift にしてください。",
