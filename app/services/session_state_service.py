    ...
    def extract_state(self, *, session, messages, characters):
        ...
        try:
            ...
            if isinstance(existing_state_json, dict):
                for key in ("scene_progression", "scene_choices", "session_memory", "conversation_director", "relationship_state", "line_visual_note", "visual_state", "displayed_image_observation", "player_visible_reaction"):
