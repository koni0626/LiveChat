    ...
    def _build_character_prompt(self, context: dict, user_text: str):
        ...
        return "\n".join(
            [
                ...
                "character_summary, speech_style, speech_sample, first_person, second_person, personality, memory_notes, memory_profile, favorite_items, feed_profile_text を強く反映してください。",
