            ...
            normalized.append(
                {
                    ...
                    "choice_type": str(item.get("choice_type") or item.get("transition_type") or "").strip()[:40],
...
def generate_choice_execution(text_ai_client, context: dict, choice: dict) -> dict:
    try:
        ...
        return {
            ...
            "choice_type": str(parsed.get("choice_type") or parsed.get("transition_type") or "").strip()[:40],
